...
/**
 *  \file       core/modules/mp/doc/pdf_standard.modules.php
 *  \ingroup    mp
...
/**
 *	Class to manage PDF template standard_mppagos
 */
class pdf_standard_mppagos extends ModelePDFMppagos
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_MPPAGOS_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->mp->dir_output.'/mppagos') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->mp->dir_output.'/mppagos';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->mp->dir_output.'/mppagos/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('MP_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('MP_DRAFT_WATERMARK')));
		}
